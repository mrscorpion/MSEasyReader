...
- (void)viewDidLoad {
    ...
    subtitle.text = @"专注于精选 iOS/OS X 开发者博客";
    ...
    [bottom setTitle:@"mr.scorpion" forState:UIControlStateNormal];
...
- (void)_emailTapped:(id)sender{
    ...
    webViewController.title = @"mr.scorpion";
    [webViewController loadURLString:@"https://mr.scorpion.github.io"];
}
